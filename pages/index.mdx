...
<div className="home-content" style={{height: '100vh'}}>
  <div className="content-container">
    <h1 className="headline">AI Solution for<br className='sm:block hidden'/> Multilingual <br className='sm:block hidden'/>  Website Localization </h1>
    ...
    <img src="/3D-banner.png" alt="AIi18n" className="banner sm:block hidden'"/>
  </div>
